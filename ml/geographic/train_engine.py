...
c_feat, h_feat, targets = get_engineered_data("train")
zones_df = pd.read_csv("../../data/synthetic/zones.csv")
accounts_df = pd.read_csv("../../data/synthetic/accounts.csv")
...
with open("../../artifacts/models/trained_model_m8.json", "w") as f:
    json.dump(trained_artifacts, f, indent=2)

with open("../../artifacts/models/rich_registry.json", "w") as f:
